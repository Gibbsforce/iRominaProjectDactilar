...
<body>
	...
	<div class="select-language">
		<div class="action-lang">
			<ul>
				...
				<li><a href="../es/contact/contact.php">es</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="firstnavbar">
		<ul class="firstnavbar-links">
			...
			<li><a class="about" href="../about/about">about</a></li>
			<li><a class="contact"href="./contact.php">contact</a></li>
			<li><a class="shop" href="../shop/shop">shop</a></li>
		</ul>
	...
	<div class="contact-form">
		<form method="POST">
			...
			<div class="full-name">
				...
				<div class="first-name">
					<label class="name-sub" for="name">Name*</label>
					<input type="text" name="firstname" required>
					<label class="subtitle-firstname" for="firstname">First Name</label>
				</div>

				<div class="last-name">
					<br><input type="text" name="lastname" required>
					<label class="subtitle-lastname" for="lastname">Last Name</label>
				</div>
    	...
    	if(isset($_POST['submit'])){
    	    ...
    	    include_once 'contact_connect.php';
    	    $obj = new Contact();
